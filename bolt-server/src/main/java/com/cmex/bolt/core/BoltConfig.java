...
public record BoltConfig(
    ...
    public static final BoltConfig DEFAULT = new BoltConfig(1, ".", 9090, false, 4, 1024,
            512, 512, true, 9091, true, "localhost", 9090, 9092, 100, 5000, false, "journal", false);
        ...
        if (args.length == 0) {
            ...
            try {
                ...
                return new BoltConfig(nodeId, boltHome, port, isProd, group, sequencerSize, matchingSize, responseSize,
                        ...
                        batchSize, batchTimeout, enableJournal, journalFilePath, isBinary);
    ...
    public static void printUsage() {
        ...
        System.out.println("  java -jar bolt.jar {nodeId} {boltHome} {port} {isProduction} {group} {sequencerSize} {matchingSize} {responseSize} {enablePrometheus} {prometheusPort} {isMaster} {masterHost} {masterPort} {replicationPort} {batchSize} {batchTimeoutMs} {enableJournal} {journalFilePath} {isBinary}");
        ...
        System.out.println("  java -jar bolt.jar 1 /path/to/bolt 9090 true 4 1024 512 512 true 9091 true localhost 9090 9092 100 5000 false journal false");
        System.out.println("  java -DLOGS_DIR=/var/log/bolt -jar bolt.jar 1 /path/to/bolt 9090 true 4 1024 512 512 true 9091 false localhost 9090 9092 100 5000 true journal.data true");
    }
}
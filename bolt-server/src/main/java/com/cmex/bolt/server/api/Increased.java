...
public class Increased extends Struct implements Supplier<Bolt.IncreaseResponse> {
    ...
    public Bolt.IncreaseResponse get() {
        Bolt.Balance balance = Bolt.Balance.newBuilder()
                ...
                .build();
        return Bolt.IncreaseResponse.newBuilder().setCode(1).setData(balance).build();
    }
}

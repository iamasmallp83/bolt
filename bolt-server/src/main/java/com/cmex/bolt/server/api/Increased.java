...
public class Increased extends Struct implements Supplier<Envoy.IncreaseResponse> {
    ...
    public Envoy.IncreaseResponse get() {
        Envoy.Balance balance = Envoy.Balance.newBuilder()
                ...
                .build();
        return Envoy.IncreaseResponse.newBuilder().setCode(1).setData(balance).build();
    }
}
